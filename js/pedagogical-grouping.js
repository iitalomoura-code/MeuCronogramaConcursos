(function (global) {
  ...
  const RULES = [
    ...
    { subjects: ["direito administrativo", "administrativo"], title: "Organização administrativa", terms: ["administracao direta", "administracao indireta", "autarquia", "fundacao publica", "empresa publica", "sociedade de economia mista", "descentralizacao", "desconcentracao"] },
