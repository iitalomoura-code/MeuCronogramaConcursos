...
assert.ok(index.includes("app.js?v=20260911-history-inheritance-canonical-matching"), "A publicação precisa solicitar a versão atual do fluxo de confirmação.");
