...
assert.ok(index.includes('app.js?v=20260921-priority-performance'), "A página publicada deve receber uma versão nova do app ao atualizar o shell de abertura.");
