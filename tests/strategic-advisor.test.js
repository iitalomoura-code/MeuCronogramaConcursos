...
assert.ok(app.includes("strategicAdvisorExecutiveMarkup") && app.includes("Ver diagnóstico detalhado do sistema"), "O modal deve priorizar uma leitura executiva e manter os detalhes recolhidos.");
