...
const events = [
  { eventId: "completed-1", materia: "Contabilidade", assunto: "Lançamentos", status: "Concluído", completedAt: today, durationMinutes: 60 },
  { eventId: "completed-1", materia: "Contabilidade", assunto: "Lançamentos", status: "Concluído", completedAt: today, durationMinutes: 60 },
  { eventId: "planned", materia: "Português", assunto: "Reescrita", status: "Não iniciado", completedAt: today, durationMinutes: 45 },
  { eventId: "progress", materia: "AFO", assunto: "Receita", status: "Em andamento", completedAt: today, durationMinutes: 30 },
  { eventId: "snapshot", materia: "Direito", assunto: "Atos", status: "Concluído", completedAt: yesterday, durationMinutes: 45 },
  { eventId: "legacy", materia: "Legislação", assunto: "Normas", status: "Concluído", completedAt: today },
];
...
assert.equal(plan.completedAllocationsForToday([{ materia: "A", assunto: "B", status: "Concluído", completedAt: "invalido" }], now).length, 0, "Datas inválidas não podem virar execução recente.");
