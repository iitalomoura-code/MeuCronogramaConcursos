...
const result = engine.build({
  ...
  entries,
  subjects: [{ name: "Português", coverage: .4, performance: .58, questions: 20, priority: .8, openReviews: 2, remainingHours: 4 }],
});
...
assert.strictEqual(result.subjects[0].risk.level, "Prioridade", "Cobertura baixa, desempenho abaixo de 60% e revisões devem elevar o risco.");
