...
assert.ok(index.includes("styles.css?v=20260817-weekly-closing"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260817-weekly-closing"), "O JavaScript deve usar o cache-busting atual.");
