...
assert.ok(index.includes("styles.css?v=20260812-plan-selection-fix"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260812-plan-selection-fix"), "O JavaScript deve usar o cache-busting atual.");
