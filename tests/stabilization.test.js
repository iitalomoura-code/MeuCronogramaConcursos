...
assert.ok(index.includes("styles.css?v=20260730-continue-progress"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260730-continue-progress"), "O JavaScript deve usar o cache-busting atual.");
