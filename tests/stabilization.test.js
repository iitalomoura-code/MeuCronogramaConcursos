...
assert.ok(index.includes("styles.css?v=20260717-cloud-sync"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260717-cloud-refresh"), "O JavaScript deve usar o cache-busting atual.");
