...
assert.ok(index.includes("app.js?v=20260911-cycle-reconciliation"), "O JavaScript deve usar o cache-busting atual.");
assert.ok(index.includes("js/strategic-cycle-reconciliation.js?v=20260911-cycle-reconciliation"), "A reconciliação estratégica deve carregar antes do app.");
