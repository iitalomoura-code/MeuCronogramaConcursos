...
assert.ok(index.includes("app.js?v=20260903-docx-structure"), "O JavaScript deve usar o cache-busting atual.");
assert.ok(index.includes("js/document-structure-parser.js?v=20260903-docx-structure"), "O parser estrutural deve carregar antes do app.");
