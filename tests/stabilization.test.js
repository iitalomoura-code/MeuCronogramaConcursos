...
assert.ok(index.includes("styles.css?v=20260812-slogan-source-sans"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260812-brand-logo"), "O JavaScript deve usar o cache-busting atual.");
