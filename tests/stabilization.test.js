...
assert.ok(index.includes("styles.css?v=20260912-advisor-visual-hierarchy"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260912-ai-coach-local-dependencies"), "O JavaScript deve usar o cache-busting atual.");
