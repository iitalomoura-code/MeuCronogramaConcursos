...
assert.ok(index.includes("styles.css?v=20260716-plan-switcher"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260716-plan-switcher"), "O JavaScript deve usar o cache-busting atual.");
