...
assert.ok(index.includes("styles.css?v=20260908-capacity-planning"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260908-capacity-planning"), "O JavaScript deve usar o cache-busting atual.");
assert.ok(index.includes("js/capacity-planning.js?v=20260908-capacity-planning"), "A camada de capacidade deve carregar antes do app.");
