...
assert.ok(index.includes("styles.css?v=20260801-reference-duration"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260801-interaction-performance"), "O JavaScript deve usar o cache-busting atual.");
