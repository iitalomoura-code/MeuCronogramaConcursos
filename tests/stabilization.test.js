...
assert.ok(index.includes("styles.css?v=20260811-reviews-compact"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260811-reviews-compact"), "O JavaScript deve usar o cache-busting atual.");
