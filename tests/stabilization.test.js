...
assert.ok(index.includes("styles.css?v=20260903-cycle-reading"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260903-hybrid-parser"), "O JavaScript deve usar o cache-busting atual.");
assert.ok(index.includes("js/document-structure-parser.js?v=20260903-hybrid-parser"), "O parser estrutural deve carregar antes do app.");
