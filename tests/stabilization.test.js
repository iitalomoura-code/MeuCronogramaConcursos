...
assert.ok(index.includes("styles.css?v=20260913-responsive-audit"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260913-responsive-audit"), "O JavaScript deve usar o cache-busting atual.");
