...
assert.ok(index.includes("styles.css?v=20260719-danger-dialog"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260719-danger-dialog"), "O JavaScript deve usar o cache-busting atual.");
