...
assert.ok(index.includes("styles.css?v=20260802-continue-performance"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260802-continue-performance"), "O JavaScript deve usar o cache-busting atual.");
