...
assert.ok(index.includes("styles.css?v=20260812-new-plan-clean"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260812-new-plan-clean"), "O JavaScript deve usar o cache-busting atual.");
