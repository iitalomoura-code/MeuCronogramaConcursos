...
assert.ok(index.includes("styles.css?v=20260717-focus-session"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260717-focus-session"), "O JavaScript deve usar o cache-busting atual.");
