...
assert.ok(index.includes("styles.css?v=20260730-continue-refinement"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260729-hierarquia-edital"), "O JavaScript deve usar o cache-busting atual.");
