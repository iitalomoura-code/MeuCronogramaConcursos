...
assert.ok(index.includes("styles.css?v=20260913-advisor-open-performance"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260913-ai-coach-preparation-performance"), "O JavaScript deve usar o cache-busting atual.");
