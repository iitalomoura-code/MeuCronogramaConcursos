...
assert.ok(index.includes("styles.css?v=20260911-knowledge-mapping-layout"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260911-permanent-knowledge-base"), "O JavaScript deve usar o cache-busting atual.");
