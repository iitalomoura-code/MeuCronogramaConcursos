...
assert.ok(index.includes("styles.css?v=20260801-performance-modal-float"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260801-performance-modal-float"), "O JavaScript deve usar o cache-busting atual.");
