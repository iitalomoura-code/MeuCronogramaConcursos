...
assert.ok(index.includes("styles.css?v=20260805-incidence-fgv"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260805-incidence-fgv"), "O JavaScript deve usar o cache-busting atual.");
