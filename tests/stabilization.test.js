...
assert.ok(index.includes("styles.css?v=20260913-ai-coach-voice"), "O CSS deve usar o cache-busting atual.");
assert.ok(index.includes("app.js?v=20260921-priority-critical-path"), "O JavaScript deve usar o cache-busting atual.");
