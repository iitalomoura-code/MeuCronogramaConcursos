...
assert.ok(app.includes("const fallbackHours = Number(block.tempoEstudado) || Number(nextDuration) || Number(block.duracao) || 0;"), "Saved study results must fall back to the selected block duration.");
