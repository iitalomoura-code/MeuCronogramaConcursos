...
assert.ok(app.includes("Analisando sua estratégia...") && app.includes("Preparando o contexto da sua evolução...") && app.includes("Consultando o Coach..."));
assert.ok(app.includes("Análise interpretativa") && app.includes("Faça uma leitura inicial para criar seu primeiro ponto de comparação."));
